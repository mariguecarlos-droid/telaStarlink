...
import { Check, Wifi, MapPin, Zap, Shield, Phone, Star, Users, Clock, Award, Sparkles, Rocket, Radio, Circle } from "lucide-react";
...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`🎉 Parabéns ${nome}! Seu pedido foi registrado com sucesso!\n\nEm breve entraremos em contato pelo telefone ${telefone} para confirmar a entrega do seu Chip Starlink.\n\nPrepare-se para ter a melhor internet da zona rural! 🚀`);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-900/80 to-cyan-900/80 backdrop-blur-xl p-8 md:p-14 rounded-3xl border-2 border-cyan-500/40 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-white py-5 md:py-6 rounded-xl text-xl md:text-2xl font-black hover:scale-105 transition-all shadow-2xl hover:shadow-orange-500/50 flex items-center justify-center gap-3"
                  >
      ...
      <style jsx>{`
        ...
        @keyframes moveDiagonal {
          ...
          100% { transform: translate(calc(100vw + 100px), -100px); }
        }
        .animation-delay-300 {
